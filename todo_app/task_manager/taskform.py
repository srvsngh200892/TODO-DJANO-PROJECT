...
class TaskForm(forms.Form):
    ...
    tile = forms.CharField(widget=forms.TextInput(attrs=dict(required=True, max_length=30)), label=_("title"), error_messages={ 'invalid': _("This value must contain only letters, numbers and underscores.") })
    created_date = forms.EmailField(widget=forms.TextInput(attrs=dict(required=False, max_length=30)), label=_("created_date"))
